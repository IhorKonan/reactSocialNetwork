...
class Users extends React.Component {
    ...
    onPageChanged(pageNumber){
        ...
        axios.get(`https://social-network.samuraijs.com/api/1.0/users?page=${pageNumber}&count=${this.props.pageSize}`).then(respons => { this.props.setUsers(respons.data.items) });
    }
    render() {
